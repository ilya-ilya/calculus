...
\begin{problem}
	...
	\begin{enumerate}
	\begin{multicols}{2}
		\item $\sin \alpha + 2 \sin{2\alpha} + \dots + 2^{n-1} \sin{n\alpha}$;
		\item $\cos \alpha + \cos{(x + \alpha)} + \dots + \cos{(nx + \alpha)}$.
	\end{multicols}
	\end{enumerate}
\end{problem}
\begin{problem}
...
\begin{problem}
	...
	\begin{enumerate}
	\begin{multicols}{2}
		\item $C_n^0 + C_n^4 + C_n^8 + C_n^{12} + \dots$;
		\item $C_n^i + C_n^{i + 3} + C_n^{i + 6} + \dots$, $i = 0, 1, 2$.
	\end{multicols}
	\end{enumerate}
\end{problem}
\begin{problem}
